...
const Contact: React.FC = () => {
 ...
 <div className="container text-center py-5" style={{ maxWidth: '900px' }}>
   <h4 className="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s" style={{fontWeight:'600'}}>Contact Us</h4>
        ...
        <div className="row g-5">
          ...
          <div className="col-12 col-xl-1 wow fadeInUp" data-wow-delay="0.3s">
            <div className="d-flex flex-xl-column align-items-center justify-content-center">
              <a className="btn btn-xl-square btn-light rounded-circle mb-0 mb-xl-4 me-4 me-xl-0" href="/"><i className="fab fa-facebook-f" style={{marginTop:'1rem'}}></i></a>
              <a className="btn btn-xl-square btn-light rounded-circle mb-0 mb-xl-4 me-4 me-xl-0" href="/"><i className="fab fa-twitter" style={{marginTop:'1rem'}}></i></a>
              <a className="btn btn-xl-square btn-light rounded-circle mb-0 mb-xl-4 me-4 me-xl-0" href="/"><i className="fab fa-instagram" style={{marginTop:'1rem'}}></i></a>
              <a className="btn btn-xl-square btn-light rounded-circle mb-0 mb-xl-0 me-0 me-xl-0" href="/"><i className="fab fa-linkedin-in" style={{marginTop:'1rem'}}></i></a>
            </div>
          </div>
          <div className="col-12 col-xl-5 wow fadeInUp" data-wow-delay="0.1s">
            <div className="p-5 bg-light rounded draw" style={{background:'#f2f2f2 !important'}}>
              ...
              <div className="bg-white rounded p-4 mb-0">
                <h4 className="mb-3" style={{color:'black'}}>Our Branch 03</h4>
                <div className="d-flex align-items-center mb-3">
                  <p className="mb-0 text-dark me-2">Address:</p>
                  <i className="fas fa-map-marker-alt text-primary me-2"></i>
                  <p className="mb-0">123 Street New York.USA</p>
