...
//           Copyright © 2024 - All right reserved by Logigates Clothing & Shoes
//         </p>
//       </aside>
//     </footer>
//     </>
...
export default function Footer() {
  return (
    <>
     <span style={{display:'flex',justifyContent:'left',textAlign:'start', padding:'1rem', color:'#6E687B',marginTop:'2rem'}}>
     LOGIGATES TECHNOLOGIES COPYRIGHT © 2023-2024
     </span>
    </>
  )
}