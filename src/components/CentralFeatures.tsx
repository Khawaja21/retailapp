...
import '../styles/CentralFeatures.css';
import Feature from '../assets/images/features-img.png';
const CentralFeatures: React.FC = () => {
  return (
      ...
      <div className="container py-5">
        ...
        <div className="row g-4 align-items-center">
          ...
          <div className="col-lg-12 col-xl-4 wow fadeInUp" data-wow-delay="0.2s">
            <img src={Feature} className="img-fluid w-100" style={{ objectFit: 'cover' }} alt="Feature" />
          </div>
          <div className="col-xl-4">
            <div className="row gy-4 gx-0">
              <div className="col-12 wow fadeInUp" data-wow-delay="0.1s">
...
export default CentralFeatures;
