   ...
   {showLoginForm && <LoginForm />}
    ...
    <div style={{display: 'flex',flexDirection:'column' ,justifyContent: 'center', alignItems: 'center', height: '200px',padding:'3rem'}}>
          <img src={blueImage} alt="Logigates Logo" style={{maxWidth: '100%', maxHeight: '100%',marginTop:'0rem'}} />
            ...
            <input
              type="email"
              className="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" placeholder="Email Verification Code"
              value={Email}
      ...
      <label className="font-semibold text-sm pb-1 block text-accent-content">
            ...
            <input
              type="password"
              className="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" placeholder="Mobile Verification Code"
              value={Password}
            ...
            >
              <span className="inline-block mr-2">VERIFY NOW</span>
            </button>
