...
// import { isValidate } from 'some-library';
...
// };
    ...
    //     isProceed = false;
    //     errorMessage = "Please enter the value in Businessname field";
    //   } else if (Businesstype.length === 0) {
    //     isProceed = false;
    //     errorMessage = "Please enter the value in Businesstype field";
    //   } else if (Email.length === 0) {
    //     isProceed = false;
    //     errorMessage = "Please enter the value in email field";
    //   } else if (PhoneNumber.length < 9) {
    //     isProceed = false;
    //     errorMessage = "Phone must be longer than 8 characters";
  ...
  <option value="Lahore">Lahore</option>
    ...
    fontSize: '0.9rem',
    fontFamily: 'sans-serif',cursor:'pointer'}}>Sign in here</strong></p>
          </div>
            </form>
